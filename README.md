...
یک فریمورک بهینه‌سازی سرور گیمینگ برای اوبونتو نسخه ۲۲ به بالا هست که با یک اسکریپت bash سروری رو به صورت هوشمند تنظیم می‌کنه — از یه VPS ارزون ۱ گیگی تا یه سرور ددیکیت قدرتمند.
...
جی اکس **هیچ تنظیم ناامنی** اعمال نمی‌کنه. تمام مقادیر در محدوده استاندارد لینوکس هستن. اگه سخت‌افزار ضعیف باشه، به حالت Balanced برمی‌گرده. بنچمارک‌ها واقعی هستن — اگه بهبودی نباشه، صادقانه گزارش می‌ده.
